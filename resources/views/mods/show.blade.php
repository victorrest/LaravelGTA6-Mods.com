        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <aside class="space-y-6">
                <div class="card p-6 space-y-4">
                    ...
                    @endphp
                    <button
                        onclick="togglePinMod({{ $mod->id }}, {{ $isPinned ? 'true' : 'false' }})"
                        id="pin-mod-btn"
                        class="w-full inline-flex items-center justify-center px-4 py-2 text-white text-sm font-semibold rounded-lg shadow transition {{ $isPinned ? 'bg-purple-600 hover:bg-purple-700' : 'bg-gray-600 hover:bg-gray-700' }}">
